...
public class PannelloHomeUser extends JPanel implements ActionListener{
	
	private static final long serialVersionUID = 7526472295692776147L; 
	private JButton btnEsci = new JButton("Esci");
	private JButton btnLogout = new JButton("Logout");
	private JPanel pnlCalendar = new JPanel(null);
	private ModuloMezziDisponibili pnlModulo = new ModuloMezziDisponibili();
	private FinestraUser frame;
	...
	public PannelloHomeUser(FinestraUser pn) {
		frame = pn;
