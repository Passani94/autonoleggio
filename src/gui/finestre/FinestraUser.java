...
import gui.pannelli.PannelloHomeUser;

public class FinestraUser extends JFrame implements ActionListener{
	...
	public FinestraUser(String user){
		Username = user;
		try {
